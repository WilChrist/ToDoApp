...
var $author$project$Main$init = {F: 0, w: ''};
...
var $author$project$Main$view = function (toDo) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$value(toDo.w),
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{av: $author$project$Main$init, aD: $author$project$Main$update, aE: $author$project$Main$view});
